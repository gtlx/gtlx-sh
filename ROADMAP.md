...
**验收**：浏览器列出全部脚本、点开看说明、点运行出结果 ✅（2026-09-03 已验证：分组列表/说明/运行均工作）
...
- 2026-09-03：一期完成（detection/backup 分类 + 检测去重 + 全软链）→ 7b725d3
- 2026-09-03：二期 Web 索引（FastAPI 分组列表+说明+可运行）→ 28f164f